...
export default class Game6 extends Core {
    constructor() {
        ...
        this.countLvlTrue = 0;
        this.dragZone = [];
        this.taskTitle = "Визнач до якого терміну належить кожне з нижче зазначених тверджень і розстав їх відповідно";
    }
    ...
    makeAnswersList() {
        ...
        for(let i = 0; i < this.answers.length; i++) {
            ...
            let text = new createjs.Text(this.answers[i].type, "13px Arial", "#fff");
            text.set({
                lineWidth: 450,
            });
